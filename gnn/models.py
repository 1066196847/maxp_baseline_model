...
class GraphSageModel(thnn.Module):
    def __init__(self,
        ...
        self.hidden_dim = hidden_dim.split(",")
        ...
        self.layers.append(dglnn.SAGEConv(in_feats=self.in_feats,
                                          out_feats=int(self.hidden_dim[0]),
                                          aggregator_type='mean'))
                                          # aggregator_type = 'pool'))
        for l in range(1, (self.n_layers - 1)):
            self.layers.append(dglnn.SAGEConv(in_feats=int(self.hidden_dim[l-1]),
                                              out_feats=int(self.hidden_dim[l]),
                                              aggregator_type='mean'))
                                              # aggregator_type='pool'))
        self.layers.append(dglnn.SAGEConv(in_feats=int(self.hidden_dim[-1]),
